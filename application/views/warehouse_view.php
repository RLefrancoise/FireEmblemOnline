...
?>
    <div class="menu_item_row" style="width:99%;height:30px;margin:auto;text-align: left;" onmouseover="tooltip.show(this)" onmouseout="tooltip.hide(this)" title="<?php echo $item->getTooltipText(); ?>">
        <span style="float:right;display:inline-block;width:100px;height:24px;text-align:right;font-size:22px" ><?php if($item->getUses() !== false) { echo $item->getCurrentUses(); ?> / <span class="unit_display_text_green"><?php echo $item->getUses(); ?></span><?php } ?></span>
